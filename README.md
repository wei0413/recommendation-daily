...
从 2026 年 9 月 10 日开始，GitHub Actions 会在北京时间工作日上午 10:17 自动从 arXiv 检索最新论文。（tips：有些论文不挂 arXiv，所以针对特定会议，例如 SIGIR/RecSys 等，后续可以继续补充会议官网见刊的论文。）
...
GitHub Actions 会在北京时间工作日上午 10:17 运行，更新数据后部署到 GitHub Pages；也可以在 Actions 页面手动触发。没有配置大模型密钥时，论文抓取、分类和发布仍会运行，只跳过中文笔记生成。
